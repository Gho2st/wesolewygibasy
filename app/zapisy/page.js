...
const cardData = [
  {
    ...
    description:
      "Przyjdź i przekonaj się, jak komfortowe i bezpieczne warunki zapewniamy Twojemu dziecku. Nasze przestrzenie są zaprojektowane z myślą o najmłodszych, z dbałością o każdy szczegół – od ergonomicznych mebli po miejsca pełne inspirujących zabaw.",
    link: {
      href: "/galeria",
      text: "Galeria",
    },
...
export default function Zapisy() {
  return (
    <main>
      <Contact />
      <section className="px-4 md:px-[9%] py-16">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl font-bold">
            Przyjdź i poznaj nasz żłobek w Krakowie!
          </h2>
