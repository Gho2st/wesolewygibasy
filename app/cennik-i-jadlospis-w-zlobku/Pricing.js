      ...
      <main>
        ...
        <div className={classes.description}>
          <p>
            ...
            dotacji oraz jadłospisu. Nasz żłobek w Krakowie oferuje
            konkurencyjne ceny, które obejmują wszystko, czego potrzebują
            Państwa dzieci do bezpiecznej i kreatywnej nauki oraz zabawy.
            Jesteśmy dumni, że możemy zapewnić Państwa maluchom opiekę na
            najwyższym poziomie w przystępnych cenach. Dbamy o to, aby każdy
            dzień w naszym żłobku był pełen radości, nauki i zdrowego rozwoju.
          </p>
          ...
          <ul>
            ...
            <li>
              ...
              czas pobytu w żłobku (mokre chusteczki, ręcznik papierowy, nocnik
              itp.
            </li>
            <li>
