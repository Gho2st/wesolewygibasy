...
export default function Maluch() {
  return (
    <section>
      <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12 lg:gap-12 px-[9%] py-16">
        <div className="w-full lg:w-1/2 flex flex-col text-lg justify-center">
          <h2 className="text-3xl xl:text-4xl font-bold  mb-4 text-center lg:text-left">
